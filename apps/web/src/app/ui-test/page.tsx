...
const sampleProcedureData = {
  ...
  cases: {
    best: {
      assumptions:
        "Todos los elementos son pares, minimizando operaciones condicionales",
      stepsLatex: [
...
const NativeTableCosts: React.FC<{ rows: typeof sampleTableData }> = ({
  rows,
}) => (
            ...
            <section className="glass-card p-6 sm:p-8 rounded-xl border border-green-500/20">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-dark-text text-sm">
                    Botones con estilo glass-card, gradientes y transiciones
                    optimizadas
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-slate-400">
                  Construidos con clases nativas de Tailwind, sin JavaScript
                  adicional
                </p>
              </div>
            </section>
            ...
            <section className="glass-card p-6 sm:p-8 rounded-xl border border-blue-500/20">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-dark-text text-sm">
                    Fórmulas LaTeX renderizadas con KaTeX para máxima calidad
                    visual
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <p className="text-sm text-slate-300">
                  Renderizado matemático profesional con soporte completo para
                  notación LaTeX. Inline:{" "}
                  <Formula
                    latex={String.raw`O(n^2)`}
                    className="text-blue-300"
                  />{" "}
                  y{" "}
                  <Formula
                    latex={String.raw`\Theta(n \log n)`}
                ...
                <div className="space-y-3">
                  ...
                  <FormulaBlock
                    latex={String.raw`T(n) = C_1(n+1) + C_2 \cdot n + C_3 \cdot n + C_4 \cdot \frac{n}{2}`}
                  />
                  <FormulaBlock
                    latex={String.raw`T(n) = n(C_1 + C_2 + C_3 + \frac{C_4}{2}) + C_1`}
                  />
                  <FormulaBlock latex={String.raw`T(n) = \Theta(n)`} />
                </div>

                <p className="text-xs text-slate-400">
                  Soporte completo para SSR/CSR, scroll horizontal automático y
                  error handling
                </p>
              </div>
            </section>
            ...
            <section className="glass-card p-6 sm:p-8 rounded-xl border border-purple-500/20">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-dark-text text-sm">
                    Modales nativos optimizados sin glitches
                  </p>
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="space-y-4 p-6 rounded-lg bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20">
                  ...
                  <p className="text-sm text-slate-300">
                    Modal nativo sin dependencias externas, posicionamiento
                    optimizado.
                  </p>
                  <NativeButton
                    variant="secondary"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-[1000px] max-h-[90vh] glass-card rounded-xl border border-white/20 shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between border-b border-white/20 p-6">
              <h3 className="text-xl font-semibold text-white">
                Análisis con Componentes Nativos
              </h3>
              <button
                onClick={() => setShowProcedure(false)}
                className="text-slate-300 hover:text-white transition-colors p-1 hover:bg-white/10 rounded"
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-100px)]">
              <div className="space-y-6">
                ...
                <section className="space-y-3">
                  <h4 className="font-semibold text-white">
                    Pasos del Procedimiento (KaTeX)
                  </h4>
                  <div className="space-y-2">
                    {sampleProcedureData.cases.best?.stepsLatex.map(
                      (step, i) => (
                  ...
                  <p className="text-xs text-slate-400">
                    Renderizado matemático profesional con scroll horizontal
                    automático
                  </p>
                </section>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 rounded-lg border border-white/10 bg-slate-800/50">
                    ...
                    <FormulaBlock
                      latex={sampleProcedureData.cases.best?.Tlatex || ""}
                    />
                  </div>
                  <div className="p-4 rounded-lg border border-white/10 bg-slate-800/50">
                    <h4 className="font-semibold text-white mb-2">
